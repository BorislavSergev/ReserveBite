...
const Hero = () => {
    return (
        <div className="relative w-full h-[70vh] bg-primary overflow-hidden">
            ...
            <motion.div
                className="absolute top-7 sm:top-4 left-2 sm:left-10 w-32 sm:w-48 h-32 sm:h-48 rounded-full bg-cover bg-no-repeat overflow-hidden"
                style={{
            ...
            />
            <motion.div
                className="absolute top-1/3 sm:top-1/3 right-6 sm:right-6 w-32 sm:w-48 h-32 sm:h-48 rounded-full bg-cover bg-no-repeat overflow-hidden"
                style={{
            ...
            />
            <motion.div
                className="absolute bottom-8 sm:bottom-8 left-8 sm:left-28 w-32 sm:w-48 h-32 sm:h-48 rounded-full bg-cover bg-no-repeat overflow-hidden"
                style={{
